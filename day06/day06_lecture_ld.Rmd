...
myiris.long <- gather(my.iris, plant.dimension, cm, Sepal.Length:Petal.Width)

head(myiris.long)

# separate()

my.iris.long2 <- separate(myiris.long, col = "plant.dimension", 
                into = c("plant.part", "dimension"), sep = "\\.")
